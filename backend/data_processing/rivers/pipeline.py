...
# In Docker, /app is the mounted backend directory. In a source checkout,
# this file lives at <repo>/backend/data_processing/rivers/pipeline.py.
    ...
    try:
        for path in parquet_files:
            ...
            if writer is None:
                ...
                raise ValueError(
                    f"Incompatible Parquet schema in {path}; "
                    "canonical pipeline should produce identical schemas"
                )
...
def run_pipeline(
    ...
    combined = _write_combined(
        per_file, output_dir / "river_observations.parquet"
